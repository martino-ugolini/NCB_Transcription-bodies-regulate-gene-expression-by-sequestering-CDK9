...
def apply_parallel_iter(items, num_procs, func, *args, progress_bar=False, total=None, num_groups=None, backend='loky'):
    ...
    print("Entering apply_parallel_iter")

    # check if we want groups
    print("Check if we want groups")
